...
export class ProductListComponent implements OnInit {
  ...
  handleListProducts() {
    ...
    // NOTE: Anguar will reuse a component if it's currently being viewed
    //
    ...
    // now get the products for the givent category id
  ...
  handleSearchProducts() {
    ...
    this.productService.searchProductsPaginated(
      this.pageNumber -1, this.pageSize, theKeyword).subscribe(this.processResult());
  }
